<?php
/**
 * Admin Wallet Debit API
 * Allows admins to debit user wallets
 */
...
try {
    ...
    $description = trim($data['description'] ?? 'Admin debit');
    ...
    $newBalance = $walletService->debit(
        $targetUserId,
        $amount,
        'admin_debit',
        $description,
    ...
    // Log audit event
    logAuditEvent('wallet', $targetUserId, 'debit', [
        'amount' => $amount,
        'description' => $description,
